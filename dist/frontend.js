...
function setup(ctx) {
  ...
  const keyHintEl = shell.querySelector("#perflux-key-hint");
  ...
  function setKeyHint(hasKey) {
    if (!keyHintEl)
      return;
    keyHintEl.textContent = hasKey ? "A key is already saved. Leave this blank unless you want to replace it." : "No key saved yet — paste your Pollinations API key and generate once to save it.";
  }
